...
userSchema.statics.signup = async function (fname, lname, ccode, pno, email, password) {
    //todo: validation
    ...
    const user = await this.create({ fname, lname, ccode, pno, email, password: hash, isAdmin: false });
